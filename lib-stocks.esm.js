 ...
 *
 */
const debug$h = debugpkg("rules:trend");
...
function calculateTrend(stockData, {
  ...
  if (_$1.isNil(stockData[TREND_DATA])) {
    let ma1 = MA.calculate(stockData, {
      n,
      source,
      type,
...
function check$7(index, stockData, options, tsCode) {
  ...
  if (ma1 && ma2 && atr && atrdev && _$1.isArray(ma1) && _$1.isArray(ma2) && _$1.isArray(atr) && _$1.isArray(atrdev) && index < ma1.length && index < ma2.length && index < atr.length && index < atrdev.length && index >= 0) {
