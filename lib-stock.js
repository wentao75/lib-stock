(function (global, factory) {
    ...
    function checkOrder(array) {
      return array && ___default['default'].isArray(array) && array.length > 1 && ___default['default'].isObject(array[0]) && ___default['default'].has(array[0], "trade_date") && array[0].trade_date > array[array.length - 1].trade_date;
    }
    ...
    function nz(array, pos, defaultVal = 0.0) {
      if (___default['default'].isNil(array) && !___default['default'].isArray(array)) {
        return defaultVal;
      }
    ...
    function linreg(array, pos, prop, len) {
      if (___default['default'].isNil(array) || !___default['default'].isArray(array) || len <= 1 || pos < 0 || pos >= array.length || pos - len + 1 < 0) {
        return [];
      }
...
`);
    ...
    function getReportsFile() {
      return path.join(libWtdaQuery.getDataRoot(), "reports.json");
    }
    ...
    const debug$5 = debugpkg__default['default']("rules:benchmark");
    /**
...
`;
    ...
    const debug$6 = debugpkg__default['default']("rules:mmb");
...
`;
    ...
    const debug$7 = debugpkg__default['default']("rules:stoploss");
...
`;
    ...
    function subtract(array1, array2, digits) {
      if (___default['default'].isEmpty(array1) || ___default['default'].isEmpty(array2) || array1.length !== array2.length) {
        return;
      }
    ...
    function ttmwave(tradeData, {
      ...
      if (___default['default'].isEmpty(tradeData) || !___default['default'].isArray(tradeData) || tradeData.length <= 0) {
        return;
      }
    ...
    const debug$b = debugpkg__default['default']("rules:squeeze");
    ...
    function calculateSqueeze(stockData, options) {
      if (___default['default'].isNil(stockData)) return; // debug(
      //     `squeeze? ${_.isNil(stockData[SQUEEZE_DATA])} ${_.isNil(
      //         stockData[TTMWAVE_DATA]
      //     )}`
      // );

      if (___default['default'].isNil(stockData[SQUEEZE_DATA])) {
        stockData[SQUEEZE_DATA] = SQUEEZE.calculate(stockData, options.squeeze);
      }

      if (___default['default'].isNil(stockData[TTMWAVE_DATA])) {
    ...
    function checkSellTransaction$3(stockInfo, stock, index, stockData, options) {
      if (___default['default'].isNil(stock) || stock.count <= 0) return;
      calculateSqueeze(stockData, options);
      if (index < 1) return; // 检查今天index的条件
...
`;
     ...
     *
     */
    const debug$c = debugpkg__default['default']("rules:swing");
    ...
    function calculateSwing(stockData, {
      ...
      if (___default['default'].isNil(stockData[SWING_DATA])) {
    ...
    function checkSwing(index, stockData, options, tsCode) {
      ...
      if (swingData && ___default['default'].isArray(swingData) && index < swingData.length && index >= 0) {
    ...
    function checkBuyTransaction$4(stockInfo, balance, index, stockData, options) {
      ...
      if (swingData && ___default['default'].isArray(swingData) && index < swingData.length && index >= 0) {
        ...
        if (!___default['default'].isEmpty(data.trans)) {
          let currentData = stockData[index];
          let tradeDate = currentData.trade_date;
...
`;
     ...
     */
    const debug$d = debugpkg__default['default']("rules:holp");
    /**
     * 基准参数，用于测量正常买入卖出情况下的基准效果
     * 采用的买入策略为开盘买入，第二天收盘卖出；或者止损平仓
     */
    ...
    function check$3(index, stockData, options, tsCode) {
      ...
      if (___default['default'].isNil(stockData) || ___default['default'].isEmpty(stockData) || stockData.length < 20 || index < 20) {
        return;
      }
...
`;
    ...
    const debug$e = debugpkg__default['default']("rules:rsi");
    ...
    function calculateData(stockData, options) {
      ...
      if (___default['default'].isNil(stockData[RSI_DATA])) {
      ...
      if (___default['default'].isNil(stockData[MA_DATA])) {
    ...
    async function createReports$3(results, options) {
      ...
      if (!___default['default'].isEmpty(sellList)) {
...
`;
    ...
    const debug$f = debugpkg__default['default']("rules:vixfix");
    ...
    function calculateData$1(stockData, options) {
      ...
      if (___default['default'].isNil(stockData[WVF_DATA])) {
...
`;
    ...
    const debug$g = debugpkg__default['default']("rules:everyday");
...
${tsCode}: [${tradeDate}] 买入条件=${longCond[index]}，卖出条件=${shortCond[index]}
    ...
    function calculateData$2(stockData, options) {
      ...
      if (___default['default'].isNil(stockData[EVERYDAY_DATA]) || stockData.length != len) {
...
`;
    ...
    function calculateHA(tradeData) {
      if (___default['default'].isNil(tradeData)) return;

      if (___default['default'].isNil(tradeData[HADATA]) || tradeData && tradeData.length != tradeData[HADATA].length) {
        // 计算
        let hadata = [];
